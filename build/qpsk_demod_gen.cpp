...
impl mydsp {
	...
	pub fn metadata(&self, m: &mut dyn Meta) { 
		...
		m.declare("filename", r"qpsk_demod.dsp");
	...
	pub fn build_user_interface_static(ui_interface: &mut dyn UI<FaustFloat>) {
		ui_interface.open_vertical_box("qpsk_demod");
		ui_interface.add_horizontal_slider("qpsk_demod/output_gain", ParamIndex(0), 1.0, 0.0, 4.0, 0.01);
	...
	pub fn compute(
		...
		for (((input0, input1), output0), output1) in zipped_iterators {
			...
			let mut fTemp6: F32 = fTemp4 * fTemp0 - fTemp2 * fTemp3;
			self.fRec3[(self.IOTA0 & 63) as usize] = fTemp6;
			...
			*output1 = fSlow0 * (self.fConst62 * self.fRec3[(self.IOTA0 & 63) as usize] + self.fConst61 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 1)) & 63) as usize] + self.fConst60 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 2)) & 63) as usize] + self.fConst59 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 3)) & 63) as usize] + self.fConst58 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 4)) & 63) as usize] + self.fConst57 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 5)) & 63) as usize] + self.fConst56 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 6)) & 63) as usize] + self.fConst55 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 7)) & 63) as usize] + self.fConst54 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 8)) & 63) as usize] + self.fConst53 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 9)) & 63) as usize] + self.fConst52 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 10)) & 63) as usize] + self.fConst51 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 11)) & 63) as usize] + self.fConst50 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 12)) & 63) as usize] + self.fConst49 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 13)) & 63) as usize] + self.fConst48 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 14)) & 63) as usize] + self.fConst47 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 15)) & 63) as usize] + self.fConst46 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 16)) & 63) as usize] + self.fConst45 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 17)) & 63) as usize] + self.fConst44 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 18)) & 63) as usize] + self.fConst43 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 19)) & 63) as usize] + self.fConst42 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 20)) & 63) as usize] + self.fConst41 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 21)) & 63) as usize] + self.fConst40 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 22)) & 63) as usize] + self.fConst39 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 23)) & 63) as usize] + self.fConst38 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 24)) & 63) as usize] + self.fConst37 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 25)) & 63) as usize] + self.fConst36 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 26)) & 63) as usize] + self.fConst35 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 27)) & 63) as usize] + self.fConst34 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 28)) & 63) as usize] + self.fConst33 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 29)) & 63) as usize] + self.fConst32 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 30)) & 63) as usize] + self.fConst31 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 31)) & 63) as usize] + self.fConst30 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 32)) & 63) as usize] + self.fConst29 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 33)) & 63) as usize] + self.fConst28 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 34)) & 63) as usize] + self.fConst27 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 35)) & 63) as usize] + self.fConst26 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 36)) & 63) as usize] + self.fConst25 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 37)) & 63) as usize] + self.fConst24 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 38)) & 63) as usize] + self.fConst23 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 39)) & 63) as usize] + self.fConst22 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 40)) & 63) as usize] + self.fConst21 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 41)) & 63) as usize] + self.fConst20 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 42)) & 63) as usize] + self.fConst19 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 43)) & 63) as usize] + self.fConst18 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 44)) & 63) as usize] + self.fConst17 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 45)) & 63) as usize] + self.fConst16 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 46)) & 63) as usize] + self.fConst15 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 47)) & 63) as usize] + self.fConst14 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 48)) & 63) as usize] + self.fConst13 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 49)) & 63) as usize] + self.fConst12 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 50)) & 63) as usize] + self.fConst11 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 51)) & 63) as usize] + self.fConst10 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 52)) & 63) as usize] + self.fConst9 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 53)) & 63) as usize] + self.fConst8 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 54)) & 63) as usize] + self.fConst7 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 55)) & 63) as usize] + self.fConst6 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 56)) & 63) as usize] + self.fConst5 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 57)) & 63) as usize] + self.fConst4 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 58)) & 63) as usize] + self.fConst3 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 59)) & 63) as usize] + self.fConst2 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 60)) & 63) as usize] + self.fConst1 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 61)) & 63) as usize] + self.fConst0 * self.fRec3[((i32::wrapping_sub(self.IOTA0, 62)) & 63) as usize]);
