...
impl mydsp {
	...
	pub fn metadata(&self, m: &mut dyn Meta) { 
		...
		m.declare("filename", r"modulator_hs.dsp");
	...
	pub fn build_user_interface_static(ui_interface: &mut dyn UI<FaustFloat>) {
		ui_interface.open_vertical_box("modulator_hs");
		ui_interface.declare(Some(ParamIndex(0)), "unit", "Hz");
		ui_interface.add_horizontal_slider("modulator/carrier_freq", ParamIndex(0), 0.1, 0.001, 0.5, 0.0001);
		ui_interface.add_horizontal_slider("modulator/mod_index", ParamIndex(1), 3.14159, 0.0, 6.28318, 0.001);
		ui_interface.add_horizontal_slider("modulator/output_gain", ParamIndex(2), 0.8, 0.0, 1.0, 0.001);
	...
	pub fn compute(
		...
		let mut fSlow1: F32 = self.fConst64 * self.fHslider1;
