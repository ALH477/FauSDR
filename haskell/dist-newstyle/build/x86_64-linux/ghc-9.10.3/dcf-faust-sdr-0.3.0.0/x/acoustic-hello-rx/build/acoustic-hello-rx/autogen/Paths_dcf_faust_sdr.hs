...
-- at runtime using the environment variable dcf_faust_sdr_bindir.
...
-- environment variable dcf_faust_sdr_libdir.
...
-- using the environment variable dcf_faust_sdr_dynlibdir.
...
-- runtime using the environment variable dcf_faust_sdr_datadir.
...
-- variable dcf_faust_sdr_libexedir.
...
-- using the environment variable dcf_faust_sdr_sysconfdir.
...
bindir     = "/home/asher/.cabal/bin"
libdir     = "/home/asher/.cabal/lib/x86_64-linux-ghc-9.10.3-1e5d/dcf-faust-sdr-0.3.0.0-inplace-acoustic-hello-rx"
dynlibdir  = "/home/asher/.cabal/lib/x86_64-linux-ghc-9.10.3-1e5d"
datadir    = "/home/asher/.cabal/share/x86_64-linux-ghc-9.10.3-1e5d/dcf-faust-sdr-0.3.0.0"
libexecdir = "/home/asher/.cabal/libexec/x86_64-linux-ghc-9.10.3-1e5d/dcf-faust-sdr-0.3.0.0"
sysconfdir = "/home/asher/.cabal/etc"

getBinDir     = catchIO (getEnv "dcf_faust_sdr_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "dcf_faust_sdr_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "dcf_faust_sdr_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "dcf_faust_sdr_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "dcf_faust_sdr_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "dcf_faust_sdr_sysconfdir") (\_ -> return sysconfdir)
